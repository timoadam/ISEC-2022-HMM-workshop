...
The raw data are available on Movebank, click [here](https://www.datarepository.movebank.org/handle/10255/move.568) for details. These raw data have been pre-processed by sub-setting relevant columns, splitting the tracks at gaps, and creating the covariate distance to the colony (we can skip the following code chunk and load the pre-processed data instead, see the last code chunk of this section):
